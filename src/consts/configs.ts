...
export const configs: Config = {
  ...
  csHost: process.env.REACT_APP_CS_HOST,
  /** version list */
  apiHost_v1: process.env.REACT_APP_API_HOST_V1,
  debug_apiHost_v1: process.env.REACT_APP_DEBUG_API_HOST_V1,
  wsPublicHost_v1: process.env.REACT_APP_PUBLIC_WEBSOCKET_HOST_V1 || 'ws://localhost:8080',
  wsPrivateHost_v1: process.env.REACT_APP_PRIVATE_WEBSOCKET_HOST_V1 || 'ws://localhost:8080',
};
